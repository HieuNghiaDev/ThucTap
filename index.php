...
<head>
    ...
    <!-- <link rel="icon" href="picture/logo/logo.png" type="image/png"> -->
    <!-- <script>
        document.querySelector('link[rel="icon"]').href = 'picture/logo/logo.png';
    </script> -->
        ...
        <div class="container">
            ...
            <nav>
                <ul>
                    ...
                    <li><a href="https://fptjobs.com/lien-he">Liên hệ</a></li>
                </ul>
            </nav>
        </div>
    </header>
        ...
        <div class="sel-province">
            ...
            <div class="content">
                ...
                <select id="pay" name="pay">
                    ...
                    <option value="21-50">Trên 20 Triệu</option>
                </select>
            </div>
