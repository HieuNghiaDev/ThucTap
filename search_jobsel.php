...
$payRange = $_POST['pay'];
list($minPay, $maxPay) = explode("-", $payRange);

// $sql = "SELECT * FROM job WHERE province = '.$province.'  AND pay = '.$pay.' AND experience = '.$jobtype.'";
    ...
    <div class="main-div">
        <div class="left-div">
            ...
            <div class="job-main">
                ...
                $sql = "SELECT * FROM job WHERE location = '" . $province . "' AND (pay >= " . $minPay . " AND pay <= " . $maxPay . ") AND experience = '" . $jobType . "'";
                $result = mysqli_query($conn, $sql);
        ...
        <div class="right-div">
            ...
            <div class="job-suggestion">
                ...
                $sql = "SELECT * FROM job ORDER BY views DESC LIMIT $limit";
                $result = mysqli_query($conn, $sql);
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    <div class="suggested-job">
                        ...
                        <p class="salary">Mức lương: <?= $row['pay'] ?> Triệu</p>
                        <p class="location">Khu vực: <?= $row['location'] ?></p>
                    </div>
                    <?php
                }
                ?>
